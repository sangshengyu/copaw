...
/** Get localized channel label for a channel key */
export function getChannelLabel(key: string, t?: (key: string, options?: { defaultValue?: string }) => string): string {
...
/** Get icon URL for a channel key */
