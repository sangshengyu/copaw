...
"""
Create a temporary conda env, install SolutionArchitect from a wheel, run conda-pack.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack SolutionArchitect (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        # Install sa with all dependencies
