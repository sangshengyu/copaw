...
## SolutionArchitect Version

[Provide the version of SolutionArchitect you are using, e.g. 0.x.x or git commit hash.]
[Using `sa --version` in your command line or checking the version in the console UI can help.]
...
- **SolutionArchitect version:** [e.g. 0.x.x or git commit]
