...
# mypy: ignore-errors
"""ReMeLight-backed memory manager for SolutionArchitect agents."""
...
from sa.agents.memory.base_memory_manager import BaseMemoryManager
from sa.agents.model_factory import create_model_and_formatter
from sa.agents.tools import read_file, write_file, edit_file
from sa.agents.utils import get_sa_token_counter
from sa.config import load_config
from sa.config.config import load_agent_config
from sa.config.context import (
    set_current_workspace_dir,
    set_current_recent_max_bytes,
)
from sa.constant import EnvVarLoader
...
class ReMeLightMemoryManager(BaseMemoryManager):
    """Memory manager that wraps ReMeLight for SolutionArchitect agents via composition.
        ...
        **_kwargs,
        ...
        if extra_instruction:
            result = await self._reme.compact_memory(
                ...
                as_token_counter=get_sa_token_counter(agent_config),
        ...
        if not result.get("is_valid", True):
            ...
            try:
                ...
                logger.error(
                    ...
                    "https://github.com/agentscope-ai/SolutionArchitect/issues",
                )
