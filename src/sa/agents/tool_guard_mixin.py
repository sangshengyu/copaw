...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from sa.security.tool_guard.engine import get_guard_engine
        from sa.app.approvals import get_approval_service
    ...
    async def _decide_guard_action(
        ...
        if guard_result is not None and guard_result.findings:
            from sa.security.tool_guard.utils import log_findings
    ...
    async def _acting_auto_denied(
        ...
        from sa.security.tool_guard.approval import (
