# -*- coding: utf-8 -*-
"""CLI command: run SolutionArchitect app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run SolutionArchitect app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing SolutionArchitect app instance.
    """
    ...
    click.echo(f"Starting SolutionArchitect app on {url} (port {port})")
