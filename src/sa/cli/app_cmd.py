...
@click.option(
    ...
    "SolutionArchitect always uses 1 worker.",
)
def app_cmd(
    host: str,
    port: int,
    ...
    """Run SolutionArchitect FastAPI app."""
    ...
    if workers is not None:
        ...
        click.echo(
            "   SolutionArchitect always uses 1 worker for stability. "
    ...
    if reload:
        os.environ["SOLUTION_ARCHITECT_RELOAD_MODE"] = "1"
    else:
        os.environ.pop("SOLUTION_ARCHITECT_RELOAD_MODE", None)
