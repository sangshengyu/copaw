...
@click.group(
    ...
    lazy_subcommands={
        "app": ("sa.cli.app_cmd", "app_cmd", ".app_cmd"),
        "daemon": ("sa.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("sa.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("sa.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("sa.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "env": ("sa.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("sa.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "sa.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("sa.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "sa.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("sa.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("sa.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "sa.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("sa.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("sa.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("sa.cli.agents_cmd", "agents_group", ".agents_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="SolutionArchitect")
