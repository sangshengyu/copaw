...
import cn.sangshy.sa.model.skill.*;
...
public class SkillService {
    ...
    // Hub configuration
    @Value("${sa.skills.hub.base-url:}")
    private String hubBaseUrl;

    @Value("${sa.skills.hub.search-path:/api/v1/search}")
    private String hubSearchPath;

    public SkillService(SADataDir dataDir, SkillPoolStore skillPoolStore,
    ...
    public Map<String, Object> importSkillFromZip(String agentId, byte[] zipData, String targetName,
        ...
        try {
            ...
            Path tmpDir = Files.createTempDirectory("sa_skill_upload_");
            try {
    ...
    public List<HubSkillSpec> searchHubSkills(String query, int limit) {
        ...
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .header("User-Agent", "sa-skills-hub/1.0")
                    .GET()
    ...
    private void extractBuiltinSkillsFromClasspath() {
        try {
            // Destination: system temp dir to avoid polluting .sa/ root
            Path destDir = Path.of(System.getProperty("java.io.tmpdir"), "sa_builtin_skills");
    ...
    private Path getBuiltinSkillsDir() {
        ...
        Path tempBuiltinDir = Path.of(System.getProperty("java.io.tmpdir"), "sa_builtin_skills");
