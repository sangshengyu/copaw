...
public class ConfigService {
    ...
    private final SADataDir saDataDir;
    ...
    public ConfigService(ConfigStore configStore, ObjectMapper objectMapper, SADataDir saDataDir) {
        this.configStore = configStore;
        this.objectMapper = objectMapper;
        this.saDataDir = saDataDir;
    ...
    public List<Map<String, Object>> getBlockedHistory() {
        Path historyPath = saDataDir.getBlockedHistoryPath();
