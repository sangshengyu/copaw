...
import cn.sangshy.sa.storage.AuthStore;
...
public class AuthService {
     ...
     * Authentication is enabled when SOLUTION_ARCHITECT_AUTH_ENABLED env var is set to true.
     *
     * @return true if authentication is enabled
     */
    public boolean isAuthEnabled() {
        String envFlag = System.getenv("SOLUTION_ARCHITECT_AUTH_ENABLED");
        if (envFlag != null) {
